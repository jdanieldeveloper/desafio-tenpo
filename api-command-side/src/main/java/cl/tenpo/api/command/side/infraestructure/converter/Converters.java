package cl.tenpo.api.command.side.infraestructure.converter;
...
import cl.tenpo.api.command.side.infraestructure.api.model.StatusModel;
...
public class Converters {
    ...
    public static Function<Triple<SummedValuesModel, HttpStatus, String>, ResponseEntity<SummedValuesModel>> toSumedValuesResponse = from -> {
        ...
        try {
            if (Objects.nonNull(summedValuesModel) &&
                    Objects.nonNull(fromHttpStatus) && Objects.nonNull(fromEstatusDetalle)) {
